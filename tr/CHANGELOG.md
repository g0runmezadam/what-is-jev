...
- **Aynı gün, daha sonra** — yeni depolar çıkmaya devam ettikçe üç paket daha: 24, 14 ve topluluk kanalında paylaşılan son bağlantılar; toplam 38 depo (toplam sayılan 947). Bunlardan A sınıfı çıkan 16 satır tek bir denetçi tarafından yeniden okundu: 13'ü A sınıfında kaldı, 3'ü B'ye geçti. Paylaşılan iki bağlantı silinmişti, atlandı.
